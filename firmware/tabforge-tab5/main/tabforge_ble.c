...
esp_err_t tabforge_ble_start(tabforge_ble_rx_cb_t rx_cb, tabforge_ble_link_cb_t link_cb)
{
    ...
    /* The factory Tab5 C6 controller predates hosted 2.5.2 feature control
     * and fails LE Secure Connections DHKey validation. Keep the GATT link
     * encrypted with bonded legacy pairing; the app code supplies auth. */
    ble_hs_cfg.sm_sc = 0;
